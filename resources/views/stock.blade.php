        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card">
                <div class="card-header">
                    <h1><b>Sell Out for {{ $product['title'] }}</b></h1>
                    <p>
                    ...
                    <form>
                        ...
                        <div class="space-y-12">
                            ...
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <input type="hidden" name="buyin" id="buyin" value="{{ $product->quantity }}"
                        ...
                        function addData() {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    "buyin": "<?php echo $product['quantity'] * $product['price_per_item']; ?>",
                                    //   "sellout": $("#sellout").val(),
                                    "qty": $("#qty").val(),
                                    "date": $("#date").val(),
                                },
                                success: function(data) {
                                    ...
                                    if ((data.status == 1)) {
                                        ...
                                        $(location).prop('href', 'http://127.0.0.1:8000/stock')
